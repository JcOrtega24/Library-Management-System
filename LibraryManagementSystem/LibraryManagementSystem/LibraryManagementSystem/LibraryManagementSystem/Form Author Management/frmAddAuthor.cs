...
namespace LibraryManagementSystem
{
    public partial class frmAddAuthor : Form
    {
        ...
        {
            DataTable dt = Books.GetData("SELECT * FROM author WHERE Name = '" + txtName.Text + "'");
            if (txtName.Text == "")
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (errorCount == 0)
            {
                try
                {
                    ...
                    {
                        Books.executeSQL("INSERT INTO author (Name, Gender) VALUES('" + txtName.Text + "', '" + cmbGender.Text + "') "); 
                        if (Books.rowAffected > 0)
                        {
                            ...
                            Books.executeSQL("INSERT INTO logs (date, time, module, action) VALUES('" + DateTime.Now.ToString("yyyy-MM-dd ") + "','"
                                        + DateTime.Now.ToLongTimeString() + "','Author','" + txtName.Text + " added in author')");
                ...
                {
                    MessageBox.Show(error.Message, "Error on Add new author!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
