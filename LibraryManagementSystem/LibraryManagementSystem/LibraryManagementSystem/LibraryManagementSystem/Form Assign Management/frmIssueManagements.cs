...
{
    public partial class frmIssueManagements : Form
    {
        int currentPage = 1;
        int rowsPerPage = 10;
        Library1 bookList = new Library1("localhost", "librarymanagementstudent", "root", "");

        public frmIssueManagements()
        {
            InitializeComponent();
        }
        ...
        public void autoRefresh()
        {
            ...
            try
            {
                DataTable dt = bookList.GetData("SELECT Accession, Title, Author, Publisher, Language, DatePublish, Subject, Type, Department, Location, Status, Available, PageNumber, Image FROM tblbooksinformation WHERE Type = 'Books' AND Status = 'Available' AND Available <> 0 ORDER BY Accession LIMIT " + offset + ", " + rowsPerPage);
        ...
        private void frmIssueManagements_Load(object sender, EventArgs e)
        {
            autoRefresh();
        }
        ...
        private void btnIssue_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    {
                        string Accession, Title, Author, Publisher, Language, DatePublish, Subject, Type, Department, Location, Status, ImageText;
