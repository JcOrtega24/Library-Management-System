            ...
            if (empty($errors)) {
                ...
                if ($insertStmt = mysqli_prepare($link, $insertSql)) {
                    foreach ($arr as $id) {
                        ...
                        // Check if the book is available and the category is 'Books'
                            ...
                            if (mysqli_stmt_execute($stmt)) {
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    if ($row['Type'] == 'Books') {
                                        ...
                                        $errors[] = "The Category must be Books Only for book with Accession ".$id;
                                    }
                                } else {
                                    $errors[] = "The selected book with Accession ".$id." is not available.";
                                }
                            } else {
